...
class CreateInterfaceValue final : public moveit_pro::behaviors::SharedResourcesNode<BT::SyncActionNode>
{
public:
  /**
   * @brief Construct a new CreateInterfaceValue behavior
   *
   ...
   */
  CreateInterfaceValue(const std::string& name, const BT::NodeConfiguration& config,
