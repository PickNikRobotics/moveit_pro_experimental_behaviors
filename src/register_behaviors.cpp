...
public:
      ...
      [[maybe_unused]] const std::shared_ptr<moveit_studio::behaviors::BehaviorContext>& shared_resources) override
  {
    ...
    moveit_studio::behaviors::registerBehavior<CreateInterfaceValue>(factory, "CreateInterfaceValue",
                                                                        shared_resources);
    moveit_studio::behaviors::registerBehavior<GetDynamicInterfaceGroupValues>(factory, "GetDynamicInterfaceGroupValues",
                                                                        shared_resources);
    moveit_studio::behaviors::registerBehavior<GetInterfaceValueFromGroup>(factory, "GetInterfaceValueFromGroup",
                                                                        shared_resources);
    moveit_studio::behaviors::registerBehavior<AccessInterfaceValueFromGroup>(factory, "AccessInterfaceValue",
                                                                        shared_resources);
  }
};
}  // namespace experimental_behaviors
